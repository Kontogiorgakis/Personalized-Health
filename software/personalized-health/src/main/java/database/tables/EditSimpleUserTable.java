...
public class EditSimpleUserTable {
    ...
    public ArrayList<SimpleUser> allUsersDatabase() throws SQLException, ClassNotFoundException {
    ...
    /*database for email*/
    public SimpleUser databaseToSimpleUserEmail(String email) throws SQLException, ClassNotFoundException{
        Connection con = DB_Connection.getConnection();
        Statement stmt = con.createStatement();
    ...
    /*database for password*/
    public SimpleUser databaseToSimpleUserPassword(String password) throws SQLException, ClassNotFoundException{
        Connection con = DB_Connection.getConnection();
        Statement stmt = con.createStatement();
    ...
    /* csd 4412 update function*/
    public void updateUser(SimpleUser user) throws ClassNotFoundException{
        try {
            Connection con = DB_Connection.getConnection();

            Statement stmt = con.createStatement();

            String insertQuery = "UPDATE users SET username ='" + user.getUsername() + "', email = '" + user.getEmail() + "', password = '" + user.getPassword() + "', firstname = '" + user.getFirstname() + "', lastname = '" + user.getLastname() +"', birthdate = '" + user.getBirthdate() + "', gender = '" + user.getGender() + "', amka = '" + user.getAmka() + "', country = '" + user.getCountry() + "', city = '" + user.getCity() +
                    "', address = '" + user.getAddress() +"', lat = '" + user.getLat() + "', lon = '" + user.getLon() +"', telephone = '" + user.getTelephone() + "', height = '" + user.getHeight() +"', weight = '"+ user.getWeight() +"', blooddonor = '" + user.getBlooddonor() + "', bloodtype = '" + user.getBloodtype() + "' WHERE username= '" + user.getUsername()+ "'";
            //stmt.execute(table);
            System.out.println(insertQuery);
            stmt.executeUpdate(insertQuery);
            System.out.println("# The user was successfully updated in the database.");
    ...
    public SimpleUser databaseToSimpleUser(String mountanton, String string) {
